    ...
    <main className="min-h-screen gradient-background">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            {/* WeChat Contact */}
            <div className="bg-blue-100/50 p-12 rounded-xl text-center">
              ...
              <div className="bg-blue-200/40 p-6 rounded-lg mb-6">
                <h4 className="font-semibold mb-3 text-gray-800">微信服务内容：</h4>
            ...
            <div className="bg-blue-100/50 p-12 rounded-xl text-center">
              ...
              <div className="bg-blue-200/40 p-6 rounded-lg mb-6">
                <h4 className="font-semibold mb-3 text-gray-800">LinkedIn 连接价值：</h4>
                <ul className="text-sm space-y-2 text-left text-gray-800">
                  <li>🔸 专业网络建立与拓展</li>
                  <li>🔸 国际法律资源共享</li>
                  <li>🔸 跨境业务合作机会</li>
      ...
      <section className="py-20 bg-blue-200/40">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl font-bold mb-6 text-gray-800">
              专业服务信息
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-lg mb-3 text-gray-800">执业机构</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-lg mb-3 text-gray-800">专业领域</h4>
              <p className="text-sm leading-relaxed text-gray-800">
                民商事争议解决<br/>
                婚姻家事诉讼<br/>
                体育娱乐法律事务
            ...
            <div className="text-center">
              <div className="text-4xl mb-4">🕒</div>
              <h4 className="font-semibold text-lg mb-3 text-gray-800">服务时间</h4>
              <p className="text-sm leading-relaxed text-gray-800">
                工作日：9:00-18:00<br/>
                紧急情况：24小时响应<br/>
                预约制咨询服务
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <blockquote className="text-xl italic leading-relaxed mb-12 text-gray-800">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-100/50 p-6 rounded-lg">
              ...
              <h4 className="font-semibold mb-2 text-gray-800">用心倾听</h4>
              <p className="text-sm opacity-90 text-gray-800">
                认真听取每一个需求，理解背后的真实困扰
              </p>
            </div>
            <div className="bg-blue-100/50 p-6 rounded-lg">
              <div className="text-3xl mb-3">💡</div>
              <h4 className="font-semibold mb-2 text-gray-800">专业建议</h4>
              <p className="text-sm opacity-90 text-gray-800">
                基于专业知识，提供切实可行的解决方案
              </p>
            </div>
            <div className="bg-blue-100/50 p-6 rounded-lg">
              <div className="text-3xl mb-3">🤝</div>
              <h4 className="font-semibold mb-2 text-gray-800">长期伙伴</h4>
              <p className="text-sm opacity-90 text-gray-800">
                不只是一次咨询，而是长期的信任与支持
              </p>
            </div>
      ...
      <section className="py-20 bg-blue-200/40">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="inline-block bg-blue-100/50 p-8 rounded-xl">
            <p className="text-2xl font-serif font-bold mb-2 text-gray-800">
