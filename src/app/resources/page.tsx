...
export default function ResourcesPage() {
  return (
    <main className="min-h-screen gradient-background">
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg max-w-4xl mx-auto leading-relaxed text-gray-800">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center bg-blue-100/50 p-8 rounded-lg">
              <div className="text-5xl mb-4">🌐</div>
              <h3 className="font-semibold text-xl mb-4 text-gray-800">社群建设</h3>
            ...
            <div className="text-center bg-blue-100/50 p-8 rounded-lg">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="font-semibold text-xl mb-4 text-gray-800">律师网络</h3>
              <div className="space-y-2 text-sm text-gray-800">
            ...
            <div className="text-center bg-blue-100/50 p-8 rounded-lg">
              <div className="text-5xl mb-4">💫</div>
              <h3 className="font-semibold text-xl mb-4 text-gray-800">价值理念</h3>
              <div className="space-y-2 text-sm text-gray-800">
          ...
          <div className="bg-blue-200/40 p-12 rounded-xl">
            <h3 className="font-serif text-2xl font-bold text-center mb-12 text-gray-800">
              我能帮助链接的资源
            </h3>
            <div className="space-y-8">
              <div className="bg-blue-100/50 p-6 rounded-lg">
                <h4 className="font-semibold text-xl mb-6 flex items-center text-gray-800">
                  🏛️ 法律专业资源
                </h4>
                <ul className="space-y-3 text-base leading-relaxed text-gray-800">
                  <li>• 各地优秀律师推荐与对接</li>
                  <li>• 不同专业领域法律专家咨询</li>
                  <li>• 法律实务经验分享与交流</li>
                  <li>• 跨境法律服务资源整合</li>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-16 text-gray-800">
            公益实践：用行动传递温暖
          </h2>
          
          <div className="grid md:grid-cols-2 gap-12">
            {/* Ocean Conservation */}
            <div className="bg-blue-100/50 p-8 rounded-xl">
              <div className="flex items-center mb-6">
                <span className="text-4xl mr-4">🌊</span>
                <h3 className="font-serif text-2xl font-bold text-gray-800">海洋保护志愿者</h3>
              </div>
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-800">参与活动：</h4>
            ...
            <div className="bg-blue-100/50 p-8 rounded-xl">
              <div className="flex items-center mb-6">
                <span className="text-4xl mr-4">🐾</span>
                <h3 className="font-serif text-2xl font-bold text-gray-800">宠物律师团队</h3>
              </div>
              <p className="mb-6 leading-relaxed text-gray-800">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-800">服务范围：</h4>
                <ul className="space-y-2 text-sm text-gray-800">
                  <li>🏠 流浪动物救助法律支持</li>
                  <li>⚖️ 宠物权益保护法律咨询</li>
                  <li>❤️ 人动物情感连接法律守护</li>
          ...
          {/* Impact & Values */}
          <div className="mt-16 text-center bg-blue-200/40 p-12 rounded-xl">
            <h3 className="font-serif text-2xl font-bold mb-6 text-gray-800">
              公益理念与影响
            </h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <h4 className="font-semibold mb-2 text-gray-800">环境守护</h4>
                <p className="text-sm opacity-90 text-gray-800">保护海洋，就是保护未来</p>
              </div>
              <div>
                <div className="text-3xl mb-3">💝</div>
                <h4 className="font-semibold mb-2 text-gray-800">生命关怀</h4>
                <p className="text-sm opacity-90 text-gray-800">守护人与动物的温暖连接</p>
              </div>
              <div>
                <div className="text-3xl mb-3">🤲</div>
                <h4 className="font-semibold mb-2 text-gray-800">社会责任</h4>
                <p className="text-sm opacity-90 text-gray-800">用专业技能回馈社会</p>
              </div>
            </div>
          </div>
        </div>
